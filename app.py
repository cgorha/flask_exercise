...
studentOrganisationDetails = 'Hi'
studentOrganisationDetails = 'yo'
studentOrganisationDetails = 'lel'
studentOrganisationDetails = 'nope'
studentOrganisationDetails = 'define'
...
def displayRegistrationPage():
    ...
    studentName = studentOrganisationDetails
